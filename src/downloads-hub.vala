...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/downloads-hub.ui")]
private class VirtualPC.DownloadsHub : Gtk.Popover {
...
[GtkTemplate (ui= "/org/lingmo/VirtualPC/ui/downloads-hub-row.ui")]
private class VirtualPC.DownloadsHubRow : Gtk.ListBoxRow {
    [GtkChild]
    ...
    public DownloadsHubRow.from_entry (AssistantDownloadableEntry entry) {
        ...
        try {
            ...
            App.app.main_window.display_toast (new VirtualPC.Toast (_("Failed to download: %s").printf (error.message)));
        }
    }
