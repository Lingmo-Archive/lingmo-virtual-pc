...
private interface VirtualPC.UnattendedFile : GLib.Object {
...
private class VirtualPC.UnattendedRawFile : GLib.Object, VirtualPC.UnattendedFile {
...
private class VirtualPC.UnattendedScriptFile : GLib.Object, VirtualPC.UnattendedFile {
    public string dest_name { get; set; }
    public string src_path { get; set; }
    ...
    public async void copy (Cancellable? cancellable) throws GLib.Error {
        ...
        if (injection_method == InstallScriptInjectionMethod.INITRD) {
            ...
            yield VirtualPC.UnattendedFile.default_copy(disk_file, source_file.get_path (), dest_name);
    }
