...
private class VirtualPC.InstallerMedia : GLib.Object {
    public Os? os;
    ...
    public bool requires_efi {
        get {
            ...
            // Until we can consume the API above, let's force this for LINGMO OS only.
            return (os.get_id ().has_prefix("http://lingmo.org/lingmo/"));
        }
    }
