...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/display-page.ui")]
private class VirtualPC.DisplayPage: Gtk.Box {
    ...
    public VirtualPC.TransferPopover transfer_popover;
    ...
    private VirtualPC.Display? display;
    ...
    public void setup_ui (AppWindow window) {
        ...
        transfer_popover = new VirtualPC.TransferPopover (window.topbar.display_toolbar);
    }
    ...
    public void update_subtitle () {
        var machine = window.current_item as VirtualPC.Machine;
    ...
    public void show_display (VirtualPC.Display display, Widget widget) {
    ...
    public void replace_display (VirtualPC.Display display, Widget widget) {
