...
public errordomain VirtualPC.OSDatabaseError {
    NON_BOOTABLE,
    DB_LOADING_FAILED,
    UNKNOWN_OS_ID,
    UNKNOWN_MEDIA_ID
...
private class VirtualPC.OSDatabase : GLib.Object {
    ...
    public async void load () {
        ...
        try {
            ...
            warning ("Error loading LINGMO VirtualPC libosinfo database: %s", e.message);
        }
        db = loader.get_db ();
        db_loading = false;
        db_loaded ();
