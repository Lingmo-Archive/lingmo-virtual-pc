...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/assistant/assistant.ui")]
private class VirtualPC.Assistant : Hdy.Window {
    ...
    [GtkChild]
    private unowned VirtualPC.VMNameRow name_entry;
    [GtkChild]
    private unowned VirtualPC.OsChooserRow os_chooser_row;
    [GtkChild]
    private unowned VirtualPC.FirmwareRow firmware_row;
    [GtkChild]
    private unowned VirtualPC.ExpressInstallRow express_install_row;
    [GtkChild]
    private unowned VirtualPC.RamRow ram_row;
    [GtkChild]
    private unowned VirtualPC.MemoryRow storage_limit_row;
    [GtkChild]
