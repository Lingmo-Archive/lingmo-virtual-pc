...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/assistant/os-downloader.ui")]
private class VirtualPC.OsDownloader : Hdy.PreferencesWindow {
    ...
    private VirtualPC.AssistantDownloadableEntry create_entry_from_media (Osinfo.Media media) {
        var entry = new VirtualPC.AssistantDownloadableEntry.from_osinfo (media);
