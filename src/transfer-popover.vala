...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/transfer-popover.ui")]
private class VirtualPC.TransferPopover: Gtk.Popover {
    [GtkChild]
    ...
    private VirtualPC.DisplayToolbar display_toolbar;

    public TransferPopover (VirtualPC.DisplayToolbar toolbar) {
    ...
    public void add_spice_transfer (Spice.FileTransferTask transfer_task) {
        ...
        var row = new VirtualPC.TransferInfoRow (transfer_task.file.get_basename ());
