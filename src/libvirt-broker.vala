...
private class VirtualPC.LibvirtBroker : VirtualPC.Broker {
    ...
    // New == Added after VirtualPC launch
    ...
    // Existing == Existed before VirtualPC was launched
    ...
    public override async void add_source (CollectionSource source) throws GLib.Error {
        ...
        yield VirtualPC.ensure_storage_pool (connection);
