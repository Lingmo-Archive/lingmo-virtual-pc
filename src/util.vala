...
public errordomain VirtualPC.Error {
    INVALID,
    RESTORE_FAILED,
    START_FAILED,
    COMMAND_FAILED
...
namespace VirtualPC {
    ...
    public void exec_sync (string[] argv,
        ...
        if (exit_status != 0)
            throw new VirtualPC.Error.COMMAND_FAILED ("Failed to execute: %s", string.joinv (" ", argv));
    }
    ...
    // shamelessly copied form lingmo-contacts
