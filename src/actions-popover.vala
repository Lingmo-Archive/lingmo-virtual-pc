...
private class VirtualPC.ActionsPopover: Gtk.Popover {
    ...
    private string get_screenshot_filename () throws GLib.Error {
        // Translators: name of the folder under ~/Pictures for screenshots. This is the same folder where LINGMO Shell saves screenshots.
    ...
    private void preferences_activated () {
        ...
        var preferences = new VirtualPC.PreferencesWindow () {
            machine = machine,
