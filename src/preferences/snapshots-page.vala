...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/preferences/snapshots-page.ui")]
private class VirtualPC.SnapshotsPage : Hdy.PreferencesPage {
    private LibvirtMachine machine;

    [GtkChild]
    private unowned VirtualPC.ToastOverlay toast_overlay;
    ...
    private async void create_snapshot () {
        ...
        try {
            ...
            toast_overlay.display_toast (new VirtualPC.Toast (msg));
        }
        this.activity = null;
