...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/preferences/resources-page.ui")]
private class VirtualPC.ResourcesPage : Hdy.PreferencesPage {
    ...
    [GtkChild]
    private unowned VirtualPC.VMNameRow box_name_entry;
    ...
    [GtkChild]
    private unowned VirtualPC.RamRow ram_row;
    [GtkChild]
    private unowned VirtualPC.StorageRow storage_row;
    [GtkChild]
    ...
    private async void on_run_in_bg_toggled () {
        ...
        try {
            ...
            var reason = _("VirtualPC wants to run VM in background");
            ...
            var msg = _("VirtualPC is not authorized to run in background");
    ...
    private void on_domain_configuration_edited (File file,
        ...
        try {
            ...
            new_config.set_custom_xml (edited_tag,
                                       "edited",
                                       "https://wiki.lingmo.org/Apps/VirtualPC/edited");
