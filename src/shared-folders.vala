...
private class VirtualPC.SharedFolder: VirtualPC.CollectionItem {
...
private class VirtualPC.SharedFoldersManager: VirtualPC.Collection {
    ...
    private GLib.Settings settings = new GLib.Settings ("org.lingmo.virtualpc");
