...
[GtkTemplate (ui = "/org/lingmo/VirtualPC/ui/list-view.ui")]
private class VirtualPC.ListView: Gtk.ScrolledWindow {
    [GtkChild]
    private unowned Gtk.ListBox list_box;

    private AppWindow window;
    private VirtualPC.ActionsPopover context_popover;
    ...
    public void setup_ui (AppWindow window) {
        ...
        context_popover = new VirtualPC.ActionsPopover (window);
    }
    ...
    private bool launch_context_popover_for_row (Gtk.ListBoxRow box_row) {
        ...
        var row = box_row.get_child () as VirtualPC.ListViewRow;
