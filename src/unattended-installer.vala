...
private class VirtualPC.UnattendedInstaller: InstallerMedia {
    ...
    public UnattendedInstaller.from_media (InstallerMedia media, InstallScriptList scripts) throws GLib.Error {
        ...
        config = new InstallConfig ("https://wiki.lingmo.org/VirtualPC/unattended");
    ...
    public override async void prepare_for_installation (string vm_name, Cancellable? cancellable) {
        ...
        try {
           ...
           if (injection_method != InstallScriptInjectionMethod.CDROM)
            ...
            App.app.main_window.display_toast (new VirtualPC.Toast (msg));
    ...
    private const string INPUT_SOURCE_SCHEMA = "org.lingmo.desktop.input-sources";
