...
public interface VirtualPC.IConfig {
    ...
    public void save () {
        // FIXME: https://bugzilla.lingmo.org/show_bug.cgi?id=681191
    ...
    protected void load () throws GLib.Error {
        if (!has_file)
            throw new VirtualPC.Error.INVALID ("has_file is false");
...
public class VirtualPC.CollectionSource: GLib.Object, VirtualPC.IConfig {
