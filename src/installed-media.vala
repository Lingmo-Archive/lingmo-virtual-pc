...
private class VirtualPC.InstalledMedia : VirtualPC.InstallerMedia {
    ...
    protected override string? architecture {
        owned get {
            ...
            if (device_file.contains ("amd64") || device_file.contains ("x86_64") || is_lingmo)
                return "x86_64";
            else {
    ...
    private async bool decompress () throws GLib.Error {
        ...
        var decompressed_path = Path.get_basename (device_file).concat (".virtualpc");
