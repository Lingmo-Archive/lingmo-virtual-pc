Feature: LiceCD
  ...
  @create_five_local_liveCD_virtualpc
  Scenario: Create five liveCD virtualpc
  ...
  @delete_five_local_livecd_virtualpc
  Scenario: Delete five local liveCD virtualpc
    * Create new box "Core-5"
    * Create new box "Core-5 2" from "Core-5" menuitem
    * Create new box "Core-5 3" from "Core-5" menuitem
    * Create new box "Core-5 4" from "Core-5" menuitem
  ...
  # https://bugzilla.lingmo.org/show_bug.cgi?id=742392
